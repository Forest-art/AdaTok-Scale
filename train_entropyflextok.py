...
def main():
    ...
    logger = setup_logger(name="EnteropyFlexTiTok", log_level="INFO",
    ...
    model, ema_model, loss_module = create_model_and_loss_module(
        config, logger, accelerator, model_type="entropyflextitok")

    # model.load_state_dict(torch.load("/mnt/petrelfs/luxiaocheng/project/Generation/EfficientGen/FlexGen/pretrained_models/tokenizer_titok_s128.bin"), strict=False)
