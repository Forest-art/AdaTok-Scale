...
def main():
    ...
    sample_folder_dir = "./llamagen_flex_demos"
    seed = 42
    ...
    generator.load_state_dict(torch.load("exp/llamagen-flex/checkpoint-160000/unwrapped_model/pytorch_model.bin", map_location="cpu"), strict=True)
    ...
    for _ in pbar:
        ...
        samples = demo_util.sample_fn_llamagen(
            generator=generator,
            tokenizer=tokenizer,
            labels=y.long(),
            device=device
